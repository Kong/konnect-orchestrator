...
func (o *StatusCodeFilter) GetDimension() StatusCodeFilterDimension {
	if o == nil {
		return StatusCodeFilterDimension("")
	}
	return o.Dimension
}

func (o *StatusCodeFilter) GetType() FilterType {
	if o == nil {
		return FilterType("")
	}
	return o.Type
...
func (o *StatusCodeFilter) GetValues() []int64 {
	if o == nil {
		return []int64{}
	}
	return o.Values
